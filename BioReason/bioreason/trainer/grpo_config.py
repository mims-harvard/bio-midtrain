...
class DNALLMGRPOConfig(TrainingArguments):
    ...
    deepspeed: Optional[str] = field(
        default=None,
        metadata={"help": "Path to DeepSpeed configuration file. Training scripts pass this explicitly; eval-only paths leave it None so trainer.evaluate skips deepspeed_init (which requires ZeRO Stage 3)."},
    )
