...
> [Cell2Sentence](https://github.com/vandijklab/cell2sentence) as a reference
> single-cell component for the **bio-post** post-training study. The README
> below is the upstream Cell2Sentence documentation; see the
> [top-level README](../README.md) for this repository's study.
